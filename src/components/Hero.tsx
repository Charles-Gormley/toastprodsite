    ...
    <Container>
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center pt-16 pb-8 md:pt-12 md:pb-24 text-black">
        <div className="lg:w-1/2 px-4 py-6 text-center lg:text-left">
          ...
          <div className="mt-6">
            <Link href="/signup"><button className="btn btn-outline btn-lg mr-4 mb-4 bg-secondary text-white font-bold border border-transparent button-hover">Sign Up</button></Link>
          </div>
        </div>
