...
const TopicButton: React.FC<TopicButtonProps> = ({ label }) => {
  return (
    <button type="button" className="bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded inline-flex items-center mr-2 mb-2 focus:outline-none focus:shadow-outline hover:bg-gray-300">
      {label}
    </button>
  );
};
...
const NewsInterests: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
        <h1 className="text-4xl font-bold text-center mb-6">Generate a Podcast</h1>
        ...
        <div className="flex justify-center mt-6">
          <button type="submit" className="bg-blue-500 text-white font-bold py-2 px-8 rounded focus:outline-none focus:shadow-outline hover:bg-blue-700">
            Submit
          </button>
        </div>
    </div>
